...
import (
	...
	"github.com/azizndao/glib/utils/fsutil/osfs"
	"github.com/azizndao/glib/utils/typeutil"
...
func TestGetMIMEType(t *testing.T) {
	...
	err := os.WriteFile(cssPath, []byte("body{ margin:0; }"), 0o644)
...
func TestOpenFileError(t *testing.T) {
	...
	assert.NoError(t, os.Mkdir(dir, 0o500))
	defer func() {
