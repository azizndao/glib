...
func TestErrors(t *testing.T) {
	...
	t.Run("Error", func(t *testing.T) {
		cases := []struct {
			...
			{desc: "empty_slice", reasons: []error{}, expected: "github.com/azizndao/glib/common/errors.Error: the Error doesn't wrap any reason (empty reasons slice)"},
	...
	t.Run("String", func(t *testing.T) { // Note: this test is very sensitive to line changes (it checks line numbers in stacktraces). If you add lines before this, be sure to also update this test.
		...
		cases := []struct {
			...
			{desc: "empty_slice", err: emptySliceErr, expected: regexp.MustCompile("^github.com/azizndao/glib/common/errors.Error: the Error doesn't wrap any reason \\(empty reasons slice\\)\ngithub\\.com/azizndao/glib/common/errors\\.TestErrors\\.func8\n\t(.*?)/glib/common/errors/error_test\\.go:105\n")},
			{desc: "nil_error_slice", err: New([]error{nil}).(*Error), expected: regexp.MustCompile("^github.com/azizndao/glib/common/errors.Error: the Error doesn't wrap any reason \\(empty reasons slice\\)\ngithub\\.com/azizndao/glib/common/errors\\.TestErrors\\.func8\n\t(.*?)/glib/common/errors/error_test\\.go:116\n")},
			{desc: "nil_any_slice", err: New([]any{nil}).(*Error), expected: regexp.MustCompile("^github.com/azizndao/glib/common/errors.Error: the Error doesn't wrap any reason \\(empty reasons slice\\)\ngithub\\.com/azizndao/glib/common/errors\\.TestErrors\\.func8\n\t(.*?)/glib/common/errors/error_test\\.go:117\n")},
			{desc: "single", err: New("err1").(*Error), expected: regexp.MustCompile("^err1\ngithub\\.com/azizndao/glib/common/errors\\.TestErrors\\.func8\n\t(.*?)/glib/common/errors/error_test\\.go:118\n")},
			{
				desc:     "many_any",
				err:      New([]any{fmt.Errorf("err1"), "err2", nil, map[string]any{"key": "value"}, suberror}).(*Error), // nil should be excluded
				expected: regexp.MustCompile("^err1\ngithub\\.com/azizndao/glib/common/errors\\.TestErrors\\.func8\n\t(.*?)/glib/common/errors/error_test\\.go:121\n([\\d\\S\\n\\t]*?)\n\nerr2\ngithub\\.com/azizndao/glib/common/errors\\.TestErrors\\.func8\n\t(.*?)/glib/common/errors/error_test\\.go:121\n([\\d\\S\\n\\t]*?)\n\nmap\\[key:value\\]\ngithub\\.com/azizndao/glib/common/errors\\.TestErrors\\.func8\n\t(.*?)/glib/common/errors/error_test\\.go:121\n([\\d\\S\\n\\t]*?)\n\nsuberror\ngithub\\.com/azizndao/glib/common/errors\\.TestErrors\\.func8\n\t(.*?)/glib/common/errors/error_test\\.go:108\n([\\d\\S\\n\\t]*?)$"),
			},
			{
				desc:     "many_errors",
				err:      New([]error{fmt.Errorf("err1"), nil, suberror}).(*Error), // nil should be excluded
				expected: regexp.MustCompile("^err1\ngithub\\.com/azizndao/glib/common/errors\\.TestErrors\\.func8\n\t(.*?)/glib/common/errors/error_test\\.go:126\n([\\d\\S\\n\\t]*?)\n\nsuberror\ngithub\\.com/azizndao/glib/common/errors\\.TestErrors\\.func8\n\t(.*?)/glib/common/errors/error_test\\.go:108\n([\\d\\S\\n\\t]*?)$"),
			},
	...
	t.Run("FileLine", func(t *testing.T) { // Note: this test is very sensitive to line changes. If you add lines before this, be sure to also update this test.
		cases := []struct {
			...
			{desc: "OK", err: New("").(*Error), expected: regexp.MustCompile("/glib/common/errors/error_test.go:146$")},
	...
	t.Run("JSON", func(t *testing.T) {
		...
		cases := []struct {
			...
			{desc: "empty_slice", err: emptySliceErr, expected: "\"github.com/azizndao/glib/common/errors.Error: the Error doesn't wrap any reason (empty reasons slice)\""},
