...
type Config struct {
	Validator Validator // Optional validator (use NoOpValidator if not needed)
}
...
//
// Parameters:
//   - config: Server configuration including optional validator
//     If no validator is provided, NoOpValidator is used (validation disabled)
func New(config Config) *Server {
	...
	// Use provided validator or NoOpValidator if none provided
