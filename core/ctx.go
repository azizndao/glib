...
type Ctx struct {
	...
	validator  Validator    // Validator instance for request validation
}

// newCtx creates a new Context from request and response
func newCtx(w http.ResponseWriter, r *http.Request, logger *slog.Logger, validator Validator) *Ctx {
	return &Ctx{
		Request:    r,
		Response:   w,
